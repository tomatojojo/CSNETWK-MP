...
def helperCall():
    ...
    print("|   /multicast <# of people to message> <handle1>...<handleX> <message>      |    messages to another client privately rather than all clients  |")
    ...
    print("    :angry - 😠")
    print("    :thumbsup - 👍")
    print("    *Multicasting feature is also available for this message board application refer to /? for the command.")
    print("\n")
